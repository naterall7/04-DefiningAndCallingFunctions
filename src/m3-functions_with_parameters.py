...
name_and_color(name = "Nate", color = "orange")
...
def display_user_info(ans1, ans2, ans3):
    print(f"Name: {ans1}")
    print(f"Email: {ans2}")
    print(f"Age: {ans3}")
display_user_info(ans1 = "Nate Rall", ans2 = "nrall001@student.francsican.edu", ans3 = "19")