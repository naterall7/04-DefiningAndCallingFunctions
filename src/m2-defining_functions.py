...
def hello():
    hresponse = "Hello! What a beautiful day we're having! *starts coughing uncontrollably* Oh- *coughs some more* no- *the coughing turns increasingly more violent* my tuberculo- *unholy amount of coughing*"
    print(hresponse)
...
###############################################################################
def goodbye():
    gresponse = "*Windows shutting down noise*"
    print(gresponse)
goodbye()